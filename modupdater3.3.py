...
if only_actual:
    ...
    targets3 = {
        ...
        r"([^\._])(?:space_)?owner = \{\s*is_same_(?:empire|value) = ([\w\._:]+)\s*\}": r"\1is_owned_by = \2",
    ...
    targets4 = {
        ...
        r"\{\s+(?:space_)?owner = \{\s*is_same_(?:empire|value) = [\w\._:]+\s*\}\s*\}": [r"\{\s+(?:space_)?owner = \{\s*is_same_(?:empire|value) = ([\w\._:]+)\s*\}\s*\}", r"{ is_owned_by = \1 }"],
