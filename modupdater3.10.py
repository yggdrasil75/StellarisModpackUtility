...
only_upto_version = "3.10" # Only supports numbers as int or with one digit after the decimal point (only 3-3.8 is supported yet)
...
v3_0 = {
    ...
    "targets3": {
        ...
        r"((?:controller|(?:space_)?owner|overlord) = \{|is_ai = (?:yes|no) )is_same_value =": r"\1is_same_empire =",
